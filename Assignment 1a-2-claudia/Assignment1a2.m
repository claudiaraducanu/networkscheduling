...
[Nodes, K, cost, capacity, origin, destination, demand, airports] = matrixsetup(input);
...
%Parameters
    ...
    p_k_init = {}; % P{3,1}(2) is the second step in the path of k=3
    
    [dist, path, pred] = graphshortestpath(cost,origin(1),destination(1),...
                        'Directed', false);
